...
# # s_linclass_gboosting [<img src="https://www.arpm.co/lab/icons/icon_permalink.png" width=30 height=30 style="display: inline;">](https://www.arpm.co/lab/redirect.php?code=s_linclass_gboosting&codeLang=Python)
...
# ## [Input parameters](https://www.arpm.co/lab/redirect.php?permalink=s_linclass_gboosting-parameters)
...
# ## [Step 1](https://www.arpm.co/lab/redirect.php?permalink=s_linclass_gboosting-implementation-step01): Define features and target variables
...
# ## [Step 3](https://www.arpm.co/lab/redirect.php?permalink=s_linclass_gboosting-implementation-step03): Gradient boosting classifier

gboosting = GradientBoostingClassifier(n_estimators=l_)
gboosting = gboosting.fit(psi_z, x)

# ## [Step 4](https://www.arpm.co/lab/redirect.php?permalink=s_linclass_gboosting-implementation-step04): Linear classifier

# +


def p_theta(z):
    return gboosting.predict_proba(z)


def chi_theta(z):
    return gboosting.predict(z)


# -

# ## [Step 5](https://www.arpm.co/lab/redirect.php?permalink=s_linclass_gboosting-implementation-step05): Predictions
...
ax2.set_zlabel('$X$')
ax2.set_title('Surface fitted with gradient boosting', fontweight='bold')
ax2.set_xlim([-2, 2])
ax2.set_ylim([-2, 2])
