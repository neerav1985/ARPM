...
# Arbitrary point predictor
def chi_arb(var):
    return 1/var
# -

# ## [Step 1](https://www.arpm.co/lab/redirect.php?permalink=s_logn_mean_regression-implementation-step01): Generate sample
...
# ## [Step 3](https://www.arpm.co/lab/redirect.php?permalink=s_logn_mean_regression-implementation-step03): Expectation and covariance of (Xbar, eps)
...
d = np.array([[1, 0], [-1, 1]])  # (Xbar, eps)=d*(Xbar, X)
