...
# ## [Step 1](https://www.arpm.co/lab/redirect.php?permalink=s_logn_quant_lin_regression-implementation-step01): Generate sample

# dispersion matrix
sig2_xz = np.array([[sig_x**2, rho_xz*sig_x*sig_z],
                    [rho_xz*sig_x*sig_z, sig_z**2]])
# jointly lognormal sample
...
xbar = chi_alpha_beta(z)
eps = x-xbar
# -

# ## [Step 3](https://www.arpm.co/lab/redirect.php?permalink=s_logn_quant_lin_regression-implementation-step03): Expectation and covariance of (Xbar, eps)

# +
# expectation and covariance of (X,Z)
...
mu_xbar_eps = a + b@np.reshape(exp_x_z, (-1, 1))
sig2_xbar_eps = b@cv_x_z@b.T
# -
...
ax1.annotate('$\overline {X}=\chi(z)$', fontsize=20, color=orange,
