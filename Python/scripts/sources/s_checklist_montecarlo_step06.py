...
# # s_checklist_montecarlo_step06 [<img src="https://www.arpm.co/lab/icons/icon_permalink.png" width=30 height=30 style="display: inline;">](https://www.arpm.co/lab/redirect.php?code=s_checklist_montecarlo_step06&codeLang=Python)
...
# ## [Input parameters](https://www.arpm.co/lab/redirect.php?permalink=s_checklist_montecarlo_step06-parameters)
...
# ## [Step 0](https://www.arpm.co/lab/redirect.php?permalink=s_checklist_montecarlo_step06-implementation-step00): Load data
...
# ## [Step 1](https://www.arpm.co/lab/redirect.php?permalink=s_checklist_montecarlo_step06-implementation-step01): Determine stock holdings

h_stocks = np.zeros(n_stocks)
for n in range(n_stocks):
    h_stocks[n] = np.floor(1/n_stocks * v_stocks_budg_tinit/v_tinit[n])

# ## [Step 2](https://www.arpm.co/lab/redirect.php?permalink=s_checklist_montecarlo_step06-implementation-step02): Define holdings
...
# ## [Step 3](https://www.arpm.co/lab/redirect.php?permalink=s_checklist_montecarlo_step06-implementation-step03): Determine initial value of cash holding

# cash at time t_init
cash_tinit = v_h_tinit - h.T@v_tinit

# ## [Step 4](https://www.arpm.co/lab/redirect.php?permalink=s_checklist_montecarlo_step06-implementation-step04): Determine current value of holding
...
# ## [Step 5](https://www.arpm.co/lab/redirect.php?permalink=s_checklist_montecarlo_step06-implementation-step05): Calculcate ex-ante performance

# ex-ante performance (P&L)
y_h = pi_tnow_thor@h

# ## [Step 6](https://www.arpm.co/lab/redirect.php?permalink=s_checklist_montecarlo_step06-implementation-step06): Save databases
