...
# # s_checklist_historical_step09 [<img src="https://www.arpm.co/lab/icons/icon_permalink.png" width=30 height=30 style="display: inline;">](https://www.arpm.co/lab/redirect.php?code=s_checklist_historical_step09&codeLang=Python)
# For details, see [here](https://www.arpm.co/lab/redirect.php?permalink=ex-vue-9-historical).
...
# ## [Input parameters](https://www.arpm.co/lab/redirect.php?permalink=s_checklist_historical_step09-parameters)

# +
v_stocks_min = 200e6  # minimum budget to invest in stocks

lambda_inf = 1e-7  # minimum value of the parameter lambda
lambda_sup = 1e-5  # maximum value of the parameter lambda
lambda_step = 1e-7  # step in the lambda grid
# -

# ## [Step 0](https://www.arpm.co/lab/redirect.php?permalink=s_checklist_historical_step09-implementation-step00): Load data
...
db_aggregation_tools = pd.read_csv(path+'db_aggregation_tools_historical.csv')
...
# ## [Step 1](https://www.arpm.co/lab/redirect.php?permalink=s_checklist_historical_step09-implementation-step01): Solving the first step of the mean-variance approach
...
# ## [Step 2](https://www.arpm.co/lab/redirect.php?permalink=s_checklist_historical_step09-implementation-step02): Solving the second step of the mean-variance approach
...
# ## [Step 3](https://www.arpm.co/lab/redirect.php?permalink=s_checklist_historical_step09-implementation-step03): Save database
...
xp = xp*1e-6
plt.bar(xp, f, width=xp[1]-xp[0], fc=[0.7, 0.7, 0.7, 0.9],
