...
# y:   [vector] yields to maturity (for time to maturity = tau) according to the Nelson-Siegel model
    ...
    y = par.theta1 - par.theta2*((1-exp(-par.theta4_squared*tau))/(par.theta4_squared*tau)) + par.theta3*((1-exp(-par.theta4_squared*tau))/(par.theta4_squared*tau)-exp(-par.theta4_squared*tau))
