...
def ShiftedVGMoments(c,theta, sigma, nu, tau):
    ...
    # For details, see [here](https://www.arpm.co/lab/redirect.php?permalink=vg_moments).
    ...
    forthCentralM = (3*sigma**4*nu+12*sigma**2*theta**2*nu**2+6*theta**4*nu**3)*tau + (3*sigma**4+6*sigma**2*theta**2*nu+3*theta**4*nu**2)*tau**2
